...
class TutorMyReportsScreen extends ConsumerWidget {
  const TutorMyReportsScreen({super.key});
  ...
  Widget _card(ShellTheme shell, MyReport r) {
    final target =
        _targetLabels[r.targetType] ?? (r.targetType ?? '대상');
      ...
      child: Column(
        ...
        children: [
          ...
          if (reasonText.isNotEmpty) ...[
            ...
            Text(reasonText,
                style: TextStyle(
                    fontSize: 13, color: shell.subtitleColor)),
          ],
